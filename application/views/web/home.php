          ...
          <div class="row">
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="index.html"><img src="<?=base_url()?>assets/web/images/geologi.png" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-10 col-lg-8 col-md-8 col-sm-9">
              <div class="header_information">
               ...
               <div class="mean-last">
                       <a href="#"><img src="<?=base_url()?>assets/web/images/search_icon.png" alt="#" /></a> <a href="#">login/sign up</a></div>              
             </div>
           </div>
         </div>
       </div>
              ...
              <div class="carousel-caption">
                <div class="row">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                    <div class="text-bg">
                      <h1>Geologi Banyuwangi</h1>
                      <p>Jenis Batuan di Banyuwangi</p>
                      <a href="#">Read more</a> <a href="#">get a qoute</a>
                    </div>
                  </div>
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?=base_url()?>assets/web/images/banyu.jpg"></figure>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <h2>Tentang <strong class="yellow"></strong></h2>
          <h2><strong class="yellow">Geologi Banyuwangi</strong></h2>
          <p>Kondisi geologi setiap wilayah bervariasi, serta memiliki peran bagi terbentuknya suatu bentukan lahan di wilayah tersebut. Berdasarkan struktur geologi, luas tanah di Kabupaten Banyuwangi sebagian besar merupakan hasil Gunung Api Kwarter Muda (30%) dan Aluvium (23%) yang berupa tanah liat, halus dan dapat menampung air hujan sehingga cocok untuk dimanfaatkan sebagai lahan pertanian. Struktur geologi lainnya adalah Miosen falses semen 16%, Miosen falses batu gamping 13%, hasil Gunung Api Kwarter tua dengan luas 10% dan struktur geologi Andesit merupakan struktur geologi terendah di Kabupaten Banyuwangi dengan luas hanya sebesar 8%   </p>
          <a href="Javascript:void(0)">Read more</a>
        </div>
      </div>
      <div class="col-xl-50 col-lg-6 col-md-8 col-sm-12">
        <div class="about-box">
          <figure><img src="<?=base_url()?>assets/web/images/struktur.jpg" alt="#" /></figure>
        </div>
      </div>
    </div>
      ...
      <div class="footer ">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12">
              <h2>IDENTITAS</h2>
              <h2><span>Rusli Karim Gunawan<h2>
              <h2><span>Sains Informasi Geografi-2020<h2>
              <h2><span>Universitas Pendidikan Indonesia<h2>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
              <div class="row">
                  ...
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        ...
                        <br>Jawa Barat </li>
                        <li>
                          <a href="#"><img src="<?=base_url()?>assets/web/icon/email.png" alt="#" /></a>rusli@gmail.com </li>
                          <li>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="address">
                          ...
                          <ul class="Links_footer">
                            ...
                            <li><a href="#">Banyuwangi</a> </li>
                            <li><a href="#">Peta</a> </li>
                            <li><a href="#">Geologi</a> </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 ">
                        <div class="address">
                          <a href="index.html"> <img src="<?=base_url()?>assets/web/images/footpage.png" alt="logo"></a>
                        </div>
                      </div>
                    </div>
                  </div>
